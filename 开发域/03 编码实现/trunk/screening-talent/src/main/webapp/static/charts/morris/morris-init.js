	...
	return {
		init : function() {
			Morris.Donut({
				...
				colors : [ themeprimary, themesecondary, themethirdcolor,
						themefourthcolor ],
 ...
 * sysAdmin/index.jsp
 */
var InitiateLineChartSysAdmin = function() {
	return {
		init : function() {
			$.get("../admin/index/visit/query", function(data) {
				Morris.Line({
					element : 'line-chart',
					data : data,
					xkey : 'y',
...
/**
 * enterprise/e-index.jsp
 */
var InitiateLineChartEnterprise = function() {
	return {
		init : function() {
			$.get("../enterprise/index/visit/query", function(data) {
				Morris.Line({
					element : 'line-chart',
					data : data,
					xkey : 'y',
