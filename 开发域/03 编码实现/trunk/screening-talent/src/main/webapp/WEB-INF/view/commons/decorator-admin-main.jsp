		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${contextPath}/"><img alt="Brand"
					src="${contextPath}/static/images/logo.png">
				</a> <a class="navbar-brand" href="${contextPath}/">筛子网</a>
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="${contextPath}/enterpriseAdmin/enterprise/inviteRegister"
						class="text-warning">邀请注册</a>
					</li>
