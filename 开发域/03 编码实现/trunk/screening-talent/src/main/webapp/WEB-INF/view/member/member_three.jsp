...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a
            href="../form_3/${formDto.memberUuid}">招聘环节</a>
    </li>
...
<form:form commandName="formDto" cssClass="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:select id="telSelect" path="telIntentionPosition" cssClass="form-control-select2">
                <form:option value="" label="选择职位"/>
                <c:forEach items="${formDto.positionList }" var="p">
                    <form:option value="${p.positionName }" id="${p.uuid}" label="${p.positionName }"/>
                </c:forEach>
            </form:select>
    ...
    <div id="intention"
        ...
        <h4 class="page-header text-primary">面试环节&nbsp;&nbsp;<a id="enter_exam"
                                                                href="javaScript:void(0);"
                                                                class="label label-primary">进入题库</a></h4>
