...
<body>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="databox bg-white radius-bordered">
							...
							<div class="databox-right">
								<span class="databox-number themesecondary">${dto.companyRegisterAmount
									}</span>
								<div class="databox-text darkgray">企业注册总数</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="databox bg-white radius-bordered">
							...
							<div class="databox-right">
								<span class="databox-number themethirdcolor">${dto.totalMemberAmount
									}</span>
								<div class="databox-text darkgray">职工总数</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="databox bg-white radius-bordered">
							<div class="databox-left bg-themeprimary">
								<div class="databox-piechart">
									<div id="users-pie" data-toggle="easypiechart"
										class="easyPieChart" data-barcolor="#fff" data-linecap="butt"
										data-percent="100" data-animate="500" data-linewidth="3"
							...
							<div class="databox-right">
								<span class="databox-number themeprimary">${dto.activeUsersAmount
									}</span>
								<div class="databox-text darkgray">活跃用户数</div>
	...
	<script type="text/javascript">
		$(window).bind("load", function() {
			...
			//月访问量
			InitiateLineChartSysAdmin.init();
