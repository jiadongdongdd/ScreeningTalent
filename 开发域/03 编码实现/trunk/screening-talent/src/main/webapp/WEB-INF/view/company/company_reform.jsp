...
<body>
	...
	<form:form commandName="reCom" style="margin-top:80px;"
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
				...
				<form:hidden path="guid" value="${reCom.guid }"/>
				<form:input path="username" cssClass="form-control" value="${reCom.username }"
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
				<form:password path="password" id="pass" cssClass="form-control"  
					placeholder="密码长度2-16位" maxlength="16" required="required" />
				...
				<span id="passwordError" class="label label-warning"
					style="display:none;">密码长度在2-16位</span>
				<%--<label class="label label-warning" style="display: none;"
		...
		<div class="form-group">
			<label class="control-label col-lg-offset-1 col-lg-3">企业全称<em
				class="text-danger">*</em> </label>
			<div class="col-lg-4">
				<form:input path="companyName" id="companyName" value="${reCom.companyName }"
		...
		<div class="form-group">
			<label class="control-label col-lg-offset-1 col-lg-3">企业邮箱<em
				class="text-danger">*</em> </label>
			<div class="col-lg-4">
				<form:input path="companyEmail" id="companyEmail" value="${reCom.companyEmail }"
		...
		<div class="form-group">
			<label class="control-label col-lg-offset-1 col-lg-3">联系人<em
				class="text-danger">*</em> </label>
			<div class="col-lg-4">
				<form:input path="contacts" id="contacts" cssClass="form-control" value="${reCom.contacts }"
		...
		<div class="form-group">
			<label class="control-label col-lg-offset-1 col-lg-3">行业<em
				class="text-danger">*</em> </label>
			<div id="city_4" class="col-lg-4">
				<form:select path="industry" id="industry_wid" value="${reCom.industry }">
		...
		<div class="form-group">
			<label class="control-label col-lg-offset-1 col-lg-3">联系人座机或手机<em
				class="text-danger">*</em> </label>
			<div class="col-lg-4">
				<form:input path="contactsPhone" id="contactsPhone"  value="${reCom.contactsPhone }"
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
				...
				<img id="tempimg" dynsrc="" src="${contextPath}/public/image/${reCom.businessPath}?w=150"  /> <input
					type="file" accept=".jpg" name="urlbusi" id="fileuploade" size="40"
					onchange="checkFileSize();" />

				<form:input path="urlbusi" name="urlbusi" id="urlbusiImg"
		...
		<div class="form-group">
			<label class="control-label col-lg-offset-1  col-lg-3">上传公司机构证书<em
				class="text-danger">*</em> </label>
			<div class="col-lg-4">
				<img id="tempimg2" dynsrc="" src="${contextPath}/public/image/${reCom.authorityPath}?w=150"  /> <input
					type="file" accept=".jpg" name="urlauth" id="fileuploade2"
					size="40" onchange="checkFileSize2();" />
				<form:input path="urlauth" name="urlauth" id="urlauthImg"
					cssClass="form-control" readonly="true" maxlength="255"
					required="true" style="opacity: 0" />
				<form:errors path="urlauth" cssClass="label label-warning" />
				<p class="help-block">文件应是大小2M以内的jpg图片</p>
