...
<link href="${contextPath}/static/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link href="${contextPath}/static/bootstrap/css/jumbotron-narrow1.css"
	rel="stylesheet">
...
<body style=" background: url('../../static/img/login/login-bg.png');">
	...
	<div id="ban" class="container">
		<div class="jumbotron">
			<div class="lead">
				<span id="success-ok1" style="display: block;height: 100px;width: 100px; float: left"><img
					src="${contextPath}/static/img/success.png"> </span>
					
				<c:if test="${paginated.totalSize > 0 }">
					<p>共搜索到${paginated.totalSize }条信息，如果您想查看详情，请登录</p>
				</c:if>
				
				<c:if test="${paginated.totalSize == 0 }">
					<p>未搜索到您需要的信息，您可以回到首页，继续搜索其他信息</p>
				</c:if>


			</div>
			<p class="lead">
				<a class="btn btn-lg btn-success" href="${contextPath}/login"
					role="button" style="">登录</a><a class="btn btn-lg btn-success"
					href="${contextPath}/" role="button">返回首页</a>
			</p>
		</div>
	</div>
	<!-- /container -->
