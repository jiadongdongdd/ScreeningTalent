...
<ul class="nav nav-tabs">
    ...
    <c:if test="${empty formDto.uuid}">
        <li role="presentation" class="disabled"><a href="javascript:void(0);">基本信息</a>
        	<jsp:include page="../tsca/tsca.jsp"></jsp:include> 
        </li>
    ...
    <c:if test="${not empty formDto.uuid}">
        <li role="presentation"><a href="../form_2/${formDto.uuid}">基本信息</a>
				<jsp:include page="../tsca/tsca.jsp"></jsp:include> 
        </li>
...
<form:form commandName="formDto" cssClass="form-horizontal">
	...
	<script>
		$(function() {
			if("" != '${formDto.uuid}' && null != '${formDto.uuid}'){
				new TScAcnt('${formDto.uuid}');
			}else{
				$("#showSpan").html(0 + "%");  
                $("#showBar").css("width", 0 );  
                $("#showPercent").html(0); 
