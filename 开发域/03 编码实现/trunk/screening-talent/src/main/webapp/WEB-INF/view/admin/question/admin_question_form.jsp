...
<div class="row">
    ...
    <h3 class="page-header text-primary">题目录入</h3>
        ...
        <form:form cssClass="form-horizontal" commandName="formDto" action="">
            ...
            <div id="non-standard-answer" class="form-group hidden">
                ...
                <div id="answerDiv" class="col-sm-10">
                    ...
                    <form:textarea path="answer" cssClass="form-control" rows="5" disabled="true"/>
                    <form:errors path="answer" cssClass="label label-warning"/>
            ...
            <div id="professionalDiv" class="form-group">
                <label class="col-sm-2 control-label">适合职位<em class="text-danger">*</em></label>

                <div id="positionUuidDiv" class="col-sm-10">
                    <select class="form-control" name="positionUuid">
                        <c:forEach items="${formDto.positions}" var="p">
                            <option value="${p.uuid}">${p.positionName}</option>
                        </c:forEach>
                    </select>
            ...
            <div id="generalDiv" class="hidden">
                <div id="tagDiv">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div id="degreeDiv" class="col-sm-10">
                    <c:forEach items="${formDto.degrees}" var="d" varStatus="vs">
                        <input name="degree" type="radio"
                               value="${d}" ${vs.index == 1?'checked':''}/>${d.label}&nbsp;
                    </c:forEach>
                                ...
                                <td class="aui_main" style="width: auto; height: auto;">
                                    <div class="aui_content" style="padding: 0px;">
                                        <div style="width: 900px; position:relative ">
                                            <div class="data-result aui-titlespan"><em>最多选择 <strong>1</strong>
                                                项</em></div>
                                            <div class="data-tabs">
                                                <ul>
                                            ...
                                            <div class="data-error" style="display: none;">最多只能选择 1项</div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
