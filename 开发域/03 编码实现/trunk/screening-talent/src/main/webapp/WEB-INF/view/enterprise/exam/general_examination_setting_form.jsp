...
<head>
    <title>综合试卷设置</title>
    <link href="${contextPath}/static/jq22/css/jq22.css" rel="stylesheet"/>
...
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a
            href="javaScript:void(0);">综合试题设置</a>
    </li>
...
<div class="row">
    ...
    <div class="btn-group btn-group-sm" style="float: right;">
        ...
        <a class="btn  btn-primary"
           href="${contextPath}/enterprise/member/form_3/${formDto.memberUuid}" style="float: right;">返回</a>

    </div>

    <h3 class="page-header text-primary">综合试题设置</h3>
    ...
    <div class="col-lg-12 col-sm-12">
        ...
        <form:form cssClass="form-horizontal" commandName="formDto" action="">
            ...
            <form:hidden path="existed"/>

            <%--<div class="form-group">
                <div class="alert alert-info">
                    <p>系统根据您输入的职工信息，生成了基础标签，您可点击标签进行选择。</p>
                </div>
            </div>
            ...
            <div id="basicTagsDiv">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">已选择的基础标签： </label>

                    <div class="col-sm-10">
                        <div class="plus-tag tagbtn clearfix" id="myTags" style="display: block;">
                            <c:forEach items="${formDto.selectedBasicTagDtos}" var="tag">
                                <a value="${tag.id}" title="${tag.name}"
                                   href="javascript:void(0);"><span>${tag.name}</span><em></em></a>
                                <input id="basic_tag_${tag.id}" class="hidden" name="selectedBasicTags"
                                       value="${tag.id}">
                            </c:forEach>
                        </div>
                    </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">生成的基础标签： </label>
                ...
                <div class="col-sm-10">
                    ...
                    <div id="mycard-plus">
                        <div class="default-tag tagbtn">
                            <div class="clearfix">
                                <c:forEach items="${formDto.basicTags}" var="tag">
                                    <a value="${tag.id}" title="${tag.name}"
                                       href="javascript:void(0);"><span>${tag.name}</span><em></em></a>
                                </c:forEach>
                            </div>
                    ...
                    <p class="help-block">生成的基础标签，可选</p>
                </div>
            ...
            <div id="tagDiv">
                <div id="generalTagsDiv" class="form-group">
                    <label class="col-sm-2 control-label">综合标签<em class="text-danger">*</em>: </label>

                    <div id="tagsDiv" class="col-sm-10">

                        <c:forEach items="${formDto.generalTagDtos}" var="tag">
                            <a class="tags-selected" value="${tag.id}" title="${tag.name}"
                               href="javascript:void(0);"><span>${tag.name}</span></a>
                            <input type="hidden" class="general-tag" name="generalTags" value="${tag.id}">
                        </c:forEach>

                        <button class="btn btn-primary-circle btn-circle btn-sm" id="tag-plus-btn" type="button"><i
                                class="glyphicon glyphicon-plus"></i>
                        </button>
                        <form:errors path="generalTags" cssClass="label label-warning"/>
                        <p class="help-block">至少选择 <strong>1</strong>项</p>

                    </div>
                </div>
            </div>

            <div id="difficultyDegreeDiv" class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <button type="button" class="btn btn-primary" id="ignoreBtn">跳过</button>
                                ...
                                <td class="aui_main" style="width: auto; height: auto;">
                                    <div class="aui_content" style="padding: 0px;">
                                        <div style="width: 900px; position:relative ">
                                            <div class="data-result aui-titlespan"><em>至少选择 <strong>1</strong>
                                                项</em>
                                                <c:forEach items="${formDto.generalTagDtos}" var="tag">
                                            ...
                                            <div class="data-tabs">
                                                <ul>
                                                    <li onclick="removenode1(this,2)" data-selector="tab-all"
                                                        class="active"><a
                                            ...
                                            <div class="data-error" style="display: none;">至少选择 1 项</div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<script>
    ...
    $(function () {
        new GeneralExaminationSettingForm();
    });
