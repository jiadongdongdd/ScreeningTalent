...
<body>
	...
	<form:form commandName="formDto" cssClass="form-horizontal"
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:select path="platform" cssClass="form-control">
					...
					<form:options items="${formDto.platforms}" itemLabel="label" />
				</form:select>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				是:<input type="radio" name="ispush" value="true" checked="checked" />
				否:<input type="radio" name="ispush" value="false" />
				<p class="help-block">必选</p>
			</div>
		</div>
		<div class="form-group">
			<label for="content" class="col-sm-2 control-label">发布内容<em
				class="text-danger">*</em> </label>

			<div class="col-sm-10">
				<form:textarea path="content" cssClass="form-control"
					placeholder="发布内容" required="required" rows="10" cols="25" />
		...
		<div id="fileBlock"
			...
			<div class="form-group">
				<label for="category" class="col-sm-2 control-label">图片</label>
				<div class="col-sm-10">
					<input type="file" name="pictureFile" accept=".jpg" />
					<c:if test="${not empty formDto.pictureGuid}">
						<a href="${contextPath}/public/download/${formDto.pictureGuid}">下载图片</a>
					</c:if>
					<form:hidden path="pictureGuid" />
