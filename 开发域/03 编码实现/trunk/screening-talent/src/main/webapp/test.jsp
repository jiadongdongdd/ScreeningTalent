...
<script type="text/javascript" src="${contextPath }/static/js/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="${contextPath }/static/js/js/jquery.cityselect.js"></script>
