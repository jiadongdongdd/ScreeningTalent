...
import com.idsmanager.xsifter.web.controller.share.ProcessResult;

@Controller
@RequestMapping("/admin/member/")
public class AdminMemberFormController {
	...
	public String showThreeForm(@PathVariable("uuid") String uuid, Model model) {
		...
		model.addAttribute("formDto", formDto);
		return "adminMember/member_three";
	}
	...
	public String showFourForm(@PathVariable("uuid") String uuid, Model model) {
		...
		model.addAttribute("formDto", formDto);
		return "adminMember/member_four";
	}
	...
	public String showFiveForm(@PathVariable("uuid") String uuid, Model model) {
		...
		model.addAttribute("formDto", formDto);
		return "adminMember/member_five";
	}
	...
	// 完整度
	@RequestMapping(value = "tscAcnt/{uuid}", method = RequestMethod.GET)
	@ResponseBody
	public Integer getTsNumber(@PathVariable @Valid String uuid) {
		Integer number = tScAcntPropService.loadTScAcntNumber(uuid);
		return number;
	}
