 ...
 */
@Component
public class CompanyReSetFormDtoValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return CompanyReSetFormDto.class.equals(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {

		CompanyReSetFormDto formDto = (CompanyReSetFormDto) target;
	...
	private void validateAuthImg(CompanyReSetFormDto formDto, Errors errors) {
	...
	private void validateBusiImg(CompanyReSetFormDto formDto, Errors errors) {
	...
	private void validateEmail(CompanyReSetFormDto formDto, Errors errors) {
	...
	private void validateName(CompanyReSetFormDto formDto, Errors errors) {
	...
	private void validateUsername(CompanyReSetFormDto formDto, Errors errors) {
	...
	private void validatePassword(CompanyReSetFormDto formDto, Errors errors) {
	...
	private void validatePhone(CompanyReSetFormDto formDto, Errors errors) {
