...
import com.idsmanager.commons.utils.wx.http.HttpClientConnectionManager;
...
public class WxPrePay {
	...
	public static String getPayNo(String url, String xmlParam) {
		...
		try {
			...
			System.out.println("预交易返回结果：" + jsonStr);
	 ...
	 * @return
	 */
	public static String orderQuery(String url, String xml) {
