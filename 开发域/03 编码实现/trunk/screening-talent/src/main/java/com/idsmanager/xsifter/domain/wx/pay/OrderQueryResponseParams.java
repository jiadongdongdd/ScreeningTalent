...
public class OrderQueryResponseParams implements Serializable {

	private static final long serialVersionUID = 2695561443210403308L;
	...
	public OrderQueryResponseParams() {
		super();
	}
	...
	public String toString() {
		return "OrderQueryResponseParams [return_code=" + return_code
				...
				+ ", device_info=" + device_info + ", openid=" + openid
				...
				+ ", time_end=" + time_end + ", trade_state_desc="
				+ trade_state_desc + ", cash_fee=" + cash_fee + "]";
	}
